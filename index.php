  ...
  <center>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="text-img">
            <figure><img src="img/banner.jpg" alt="#"/></figure>
          </div>
        </div>
        <div class="col-md-12">
          <div class="text-bg">
        ...
        <div class="col-md-12">
          <div class="black_bg">
            <div class="row d_flex">
              <div class="col-md-4">
                <div class="store_box ">
                  <figure><img src="img/store1.jpg" alt="#"/></figure>
                </div>
              </div>
              <div class="col-md-8">
                <div class="store_box ">
          ...
          <div class="black_bg">
            <div class="row d_flex">
              <div class="col-md-4">
                <div class="store_box ">
                  <figure><img src="img/store2.jpg" alt="#"/></figure>
                </div>
              </div>
              <div class="col-md-8">
                <div class="store_box ">
          ...
          <div class="black_bg">
            <div class="row d_flex">
              <div class="col-md-4">
                <div class="store_box ">
                  <figure><img src="img/store3.jpg" alt="#"/></figure>
                </div>
              </div>
              <div class="col-md-8">
                <div class="store_box ">
